...
export const styles = StyleSheet.create({
  ...
  journalSheet: { flex: 1, backgroundColor: colors.bg },
  journalSheetHeader: { minHeight: 76, paddingHorizontal: 18, borderBottomWidth: 1, borderBottomColor: colors.line, flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  journalSheetKicker: { color: colors.accent, fontSize: 10, fontWeight: "900", letterSpacing: 2.5 },
  journalSheetTitle: { maxWidth: 280, marginTop: 4, color: colors.text, fontSize: 24, fontWeight: "900", fontFamily: "serif" },
  journalSheetContent: { padding: 18, paddingBottom: 70 },
  journalPrivacyCard: { flexDirection: "row", alignItems: "center", gap: 10, padding: 13, borderRadius: 13, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.panel },
  journalPrivacyText: { flex: 1, color: colors.muted, fontSize: 12, lineHeight: 18 },
  journalPrivacyStrong: { color: colors.text, fontWeight: "900" },
  journalComposerMobile: { marginTop: 16, padding: 16, borderWidth: 1, borderColor: colors.line, borderRadius: 18, backgroundColor: colors.panel },
  journalTitleInputMobile: { minHeight: 45, color: colors.text, borderBottomWidth: 1, borderBottomColor: colors.line, fontFamily: "serif", fontSize: 18, fontWeight: "800" },
  journalBodyInputMobile: { minHeight: 150, paddingTop: 15, color: colors.text, fontFamily: "serif", fontSize: 16, lineHeight: 25, textAlignVertical: "top" },
  journalDraftSection: { paddingTop: 2 },
  journalDraftSectionLater: { marginTop: 14, paddingTop: 14, borderTopWidth: 1, borderTopColor: colors.line },
  journalDraftSectionHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  journalDraftSectionLabel: { color: colors.accent, fontSize: 9, fontWeight: "900", letterSpacing: 1.5 },
  journalTargetButton: { minHeight: 42, paddingHorizontal: 2, borderTopWidth: 1, borderTopColor: colors.line, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 10 },
  journalTargetButtonCopy: { flex: 1, minWidth: 0, flexDirection: "row", alignItems: "center", gap: 7 },
  journalTargetButtonText: { flex: 1, color: colors.muted, fontSize: 11, fontWeight: "800" },
  journalTargetButtonTextActive: { color: colors.text },
  journalDraftTags: { paddingTop: 2, paddingBottom: 10, gap: 5 },
  journalTargetPicker: { padding: 9, borderWidth: 1, borderColor: colors.line, borderRadius: 13, backgroundColor: colors.bg, gap: 7 },
  journalTargetSeason: { overflow: "hidden", borderWidth: 1, borderColor: colors.line, borderRadius: 11, backgroundColor: colors.panel },
  journalTargetSeasonRow: { minHeight: 48, paddingHorizontal: 11, flexDirection: "row", alignItems: "center", gap: 8 },
  journalTargetSeasonRowActive: { backgroundColor: "rgba(240,90,56,.07)" },
  journalTargetSeasonSelect: { flex: 1, minWidth: 0, minHeight: 48, flexDirection: "row", alignItems: "center", gap: 9 },
  journalTargetCheck: { width: 20, height: 20, borderWidth: 1, borderColor: colors.line, borderRadius: 6, alignItems: "center", justifyContent: "center" },
  journalTargetCheckActive: { borderColor: colors.accent, backgroundColor: colors.accent },
  journalTargetSeasonCopy: { flex: 1, minWidth: 0 },
  journalTargetSeasonName: { color: colors.text, fontSize: 12, fontWeight: "900" },
  journalTargetSeasonCount: { marginTop: 2, color: colors.accent, fontSize: 9, fontWeight: "800" },
  journalTargetExpand: { minHeight: 38, paddingLeft: 8, flexDirection: "row", alignItems: "center", gap: 3 },
  journalTargetExpandText: { color: colors.muted, fontSize: 9, fontWeight: "900" },
  journalEpisodePicker: { paddingHorizontal: 8, paddingBottom: 8, gap: 5 },
  journalEpisodeOption: { minHeight: 42, paddingHorizontal: 9, borderRadius: 9, flexDirection: "row", alignItems: "center", gap: 9 },
  journalEpisodeOptionActive: { backgroundColor: "rgba(240,90,56,.08)" },
  journalEpisodeOptionText: { flex: 1, color: colors.muted, fontSize: 11 },
  journalEpisodeCode: { color: colors.text, fontWeight: "900" },
  journalTargetClear: { alignSelf: "flex-start", paddingHorizontal: 7, paddingVertical: 5 },
  journalTargetClearText: { color: colors.muted, fontSize: 9, fontWeight: "900" },
  journalAddSection: { alignSelf: "flex-start", minHeight: 42, paddingTop: 6, flexDirection: "row", alignItems: "center", gap: 5 },
  journalAddSectionText: { color: colors.text, fontSize: 11, fontWeight: "900" },
  journalWatchLinker: { marginTop: 8, padding: 11, borderWidth: 1, borderColor: colors.line, borderRadius: 13, backgroundColor: colors.bg, gap: 7 },
  journalWatchLinkerHeading: { paddingHorizontal: 2, paddingBottom: 4, flexDirection: "row", alignItems: "center", gap: 9 },
  journalWatchLinkerTitle: { color: colors.text, fontSize: 11, fontWeight: "900" },
  journalWatchLinkerText: { marginTop: 2, color: colors.muted, fontSize: 9, lineHeight: 13 },
  journalWatchSelect: { minHeight: 47, paddingHorizontal: 11, borderWidth: 1, borderColor: colors.line, borderRadius: 10, backgroundColor: colors.panel, flexDirection: "row", alignItems: "center", gap: 8 },
  journalWatchSelectCopy: { flex: 1, minWidth: 0 },
  journalWatchSelectLabel: { color: colors.accent, fontSize: 8, fontWeight: "900", letterSpacing: 1.1 },
  journalWatchSelectValue: { marginTop: 3, color: colors.text, fontSize: 10, fontWeight: "800" },
  journalWatchOptionsList: { maxHeight: 210, borderWidth: 1, borderColor: colors.line, borderRadius: 10, backgroundColor: colors.panel },
  journalWatchOptionsContent: { padding: 5 },
  journalWatchOption: { minHeight: 43, paddingHorizontal: 9, borderRadius: 8, flexDirection: "row", alignItems: "center", gap: 8 },
  journalWatchOptionActive: { backgroundColor: "rgba(240,90,56,.09)" },
  journalWatchOptionText: { flex: 1, color: colors.muted, fontSize: 10, lineHeight: 14 },
  journalWatchPickerSheet: { position: "absolute", left: 14, right: 14, bottom: 18, maxHeight: "82%", overflow: "hidden", borderRadius: 24, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.panel },
  journalWatchPickerHeader: { minHeight: 74, paddingHorizontal: 16, paddingVertical: 13, borderBottomWidth: 1, borderBottomColor: colors.line, flexDirection: "row", alignItems: "center", gap: 12 },
  journalWatchPickerHeaderCopy: { flex: 1, minWidth: 0 },
  journalWatchPickerTitle: { color: colors.text, fontSize: 16, fontWeight: "900" },
  journalWatchPickerSubtitle: { marginTop: 3, color: colors.muted, fontSize: 10, lineHeight: 14 },
  journalWatchRunList: { flexGrow: 0 },
  journalWatchRunListContent: { padding: 9, paddingBottom: 15, gap: 5 },
  journalWatchClear: { alignSelf: "flex-end", minHeight: 34, paddingHorizontal: 8, justifyContent: "center" },
  journalWatchClearText: { color: colors.muted, fontSize: 9, fontWeight: "900" },
  journalWatchRun: { overflow: "hidden", borderWidth: 1, borderColor: "transparent", borderRadius: 13, backgroundColor: colors.bg },
  journalWatchRunActive: { borderColor: "rgba(240,90,56,.55)", backgroundColor: "rgba(240,90,56,.055)" },
  journalWatchRunRow: { minHeight: 66, flexDirection: "row", alignItems: "stretch" },
  journalWatchRunSelect: { flex: 1, minWidth: 0, paddingHorizontal: 11, paddingVertical: 10, flexDirection: "row", alignItems: "center", gap: 10 },
  journalWatchRunRadio: { width: 19, height: 19, borderRadius: 10, borderWidth: 1, borderColor: colors.line, alignItems: "center", justifyContent: "center" },
  journalWatchRunRadioActive: { borderColor: colors.accent, backgroundColor: colors.accent },
  journalWatchRunCopy: { flex: 1, minWidth: 0, gap: 5 },
  journalWatchRunTitleRow: { flexDirection: "row", alignItems: "center", gap: 7 },
  journalWatchRunTitle: { color: colors.text, fontSize: 12, fontWeight: "900" },
  journalWatchRunStatus: { color: colors.muted, fontSize: 7, fontWeight: "900", letterSpacing: .7 },
  journalWatchRunStatusActive: { color: colors.accent },
  journalWatchRunDates: { color: colors.muted, fontSize: 9, fontWeight: "700" },
  journalWatchRunExpand: { minWidth: 62, paddingHorizontal: 9, borderLeftWidth: 1, borderLeftColor: colors.line, alignItems: "center", justifyContent: "center", gap: 3 },
  journalWatchRunExpandText: { color: colors.muted, fontSize: 8, fontWeight: "900" },
  journalWatchEpisodeList: { paddingHorizontal: 9, paddingBottom: 8 },
  journalWatchEpisodeRow: { minHeight: 43, paddingHorizontal: 8, borderTopWidth: 1, borderTopColor: colors.line, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 10 },
  journalWatchEpisodeName: { flex: 1, color: colors.text, fontSize: 10, fontWeight: "800" },
  journalWatchEpisodeDate: { color: colors.muted, fontSize: 8, fontWeight: "700" },
  journalMoodRow: { gap: 7, paddingVertical: 12 },
  journalMoodChip: { paddingHorizontal: 11, paddingVertical: 7, borderRadius: 99, borderWidth: 1, borderColor: colors.line },
  journalMoodChipActive: { borderColor: colors.accent, backgroundColor: "rgba(255,194,75,.12)" },
  journalMoodChipText: { color: colors.muted, fontSize: 11, fontWeight: "800" },
  journalMoodChipTextActive: { color: colors.accent },
  journalSelectedImages: { gap: 8, paddingBottom: 7 },
  journalSelectedImageWrap: { position: "relative", width: 76, height: 62, borderRadius: 10, overflow: "hidden", borderWidth: 1, borderColor: colors.line, backgroundColor: colors.bg },
  journalSelectedImage: { width: "100%", height: "100%" },
  journalSelectedImageRemove: { position: "absolute", top: 4, right: 4, width: 24, height: 24, borderRadius: 12, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(0,0,0,.74)" },
  journalComposerActions: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 12, marginTop: 5 },
  journalPhotoButton: { minHeight: 42, flexDirection: "row", alignItems: "center", gap: 7 },
  journalPhotoButtonText: { color: colors.text, fontSize: 12, fontWeight: "800" },
  journalSaveButton: { minWidth: 128, minHeight: 42, paddingHorizontal: 15, borderRadius: 12, backgroundColor: colors.accent, alignItems: "center", justifyContent: "center" },
  journalSaveButtonText: { color: "#101010", fontSize: 12, fontWeight: "900" },
  journalTimelineTitle: { marginTop: 30, marginBottom: 12, color: colors.text, fontFamily: "serif", fontSize: 24, fontWeight: "900" },
  journalEntryMobile: { marginBottom: 14, padding: 17, borderWidth: 1, borderColor: colors.line, borderRadius: 16, backgroundColor: colors.panel },
  journalEntryMobileHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 10 },
  journalEntryDate: { color: colors.muted, fontSize: 11, fontWeight: "800" },
  journalEntryMood: { color: colors.accent, fontSize: 10, fontWeight: "900" },
  journalEntryTitle: { marginTop: 14, color: colors.text, fontFamily: "serif", fontSize: 20, fontWeight: "900" },
  journalEntryWatchLink: { alignSelf: "flex-start", marginTop: 10, paddingHorizontal: 9, minHeight: 32, borderWidth: 1, borderColor: colors.line, borderRadius: 9, backgroundColor: colors.bg, flexDirection: "row", alignItems: "center", gap: 6 },
  journalEntryWatchLinkText: { color: colors.muted, fontSize: 10, fontWeight: "800" },
  journalEntryBody: { marginTop: 9, color: colors.text, fontFamily: "serif", fontSize: 15, lineHeight: 24 },
  journalEntryBlockMobile: { marginTop: 13, gap: 7 },
  journalEntryBlockTags: { flexDirection: "row", flexWrap: "wrap", gap: 5 },
  journalEntryBlockTag: { paddingHorizontal: 8, paddingVertical: 4, borderRadius: 99, overflow: "hidden", color: colors.accent, backgroundColor: "rgba(240,90,56,.11)", fontSize: 10, fontWeight: "900" },
  journalEntryImages: { gap: 8, paddingTop: 15 },
  journalEntryImage: { width: 180, height: 122, borderRadius: 10, backgroundColor: colors.bg },
  journalEntryEditMobile: { marginTop: 13, padding: 11, borderWidth: 1, borderColor: colors.line, borderRadius: 12, backgroundColor: colors.bg, gap: 9 },
  journalEntryEditTitleMobile: { minHeight: 42, paddingHorizontal: 10, borderWidth: 1, borderColor: colors.line, borderRadius: 9, color: colors.text, fontSize: 14, fontWeight: "800" },
  journalEntryEditBodyMobile: { minHeight: 120, padding: 10, borderWidth: 1, borderColor: colors.line, borderRadius: 9, color: colors.text, fontFamily: "serif", fontSize: 14, lineHeight: 22, textAlignVertical: "top" },
  journalEntryEditActionsMobile: { flexDirection: "row", alignItems: "center", justifyContent: "flex-end", gap: 8 },
  journalEntryEditCancelMobile: { minHeight: 38, paddingHorizontal: 11, justifyContent: "center" },
  journalEntryEditCancelTextMobile: { color: colors.muted, fontSize: 11, fontWeight: "800" },
  journalEntryEditSaveMobile: { minWidth: 116, minHeight: 38, paddingHorizontal: 12, borderRadius: 10, backgroundColor: colors.accent, alignItems: "center", justifyContent: "center" },
  journalEntryEditSaveTextMobile: { color: "#101010", fontSize: 11, fontWeight: "900" },
  journalEntryActionsMobile: { marginTop: 14, flexDirection: "row", alignItems: "center", justifyContent: "flex-end", gap: 14 },
  journalEntryActionMobile: { minHeight: 34, flexDirection: "row", alignItems: "center", gap: 5 },
  journalImageLightbox: { flex: 1, padding: 18, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(0,0,0,.92)" },
  journalImageLightboxClose: { position: "absolute", zIndex: 2, top: 54, right: 22, width: 42, height: 42, borderRadius: 21, borderWidth: 1, borderColor: "rgba(255,255,255,.22)", alignItems: "center", justifyContent: "center", backgroundColor: "rgba(18,18,18,.8)" },
  journalImageLightboxFrame: { width: "100%", height: "82%", alignItems: "center", justifyContent: "center" },
  journalImageLightboxImage: { width: "100%", height: "100%" },
  journalDeleteButton: { alignSelf: "flex-end", marginTop: 14, flexDirection: "row", alignItems: "center", gap: 5 },
  journalDeleteText: { color: colors.muted, fontSize: 10, fontWeight: "800" },
  profileJournalIntro: { marginTop: 14, marginHorizontal: 18, padding: 15, borderWidth: 1, borderColor: colors.line, borderRadius: 16, backgroundColor: colors.panel, flexDirection: "row", alignItems: "center", gap: 12 },
  profileJournalIntroIcon: { width: 38, height: 38, borderRadius: 19, backgroundColor: "rgba(240,90,56,.10)", alignItems: "center", justifyContent: "center" },
  profileJournalIntroCopy: { flex: 1, minWidth: 0 },
  profileJournalIntroTitle: { color: colors.text, fontSize: 14, fontWeight: "900" },
  profileJournalIntroText: { marginTop: 3, color: colors.muted, fontSize: 11, lineHeight: 16 },
  profileJournalSearch: { marginTop: 12, marginHorizontal: 18, minHeight: 48, paddingHorizontal: 14, borderWidth: 1, borderColor: colors.line, borderRadius: 14, backgroundColor: colors.panel, flexDirection: "row", alignItems: "center", gap: 9 },
  profileJournalSearchInput: { flex: 1, minWidth: 0, color: colors.text, fontSize: 13 },
  profileJournalEntry: { marginTop: 12, marginHorizontal: 18, padding: 12, borderWidth: 1, borderColor: colors.line, borderRadius: 17, backgroundColor: colors.panel, flexDirection: "row", alignItems: "center", gap: 12 },
  profileJournalPoster: { width: 61, height: 91, borderRadius: 10, backgroundColor: colors.panel2 },
  profileJournalPosterFallback: { width: 61, height: 91, borderRadius: 10, backgroundColor: colors.panel2, alignItems: "center", justifyContent: "center" },
  profileJournalEntryCopy: { flex: 1, minWidth: 0 },
  profileJournalMetaRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 8 },
  profileJournalDate: { color: colors.muted, fontSize: 9, fontWeight: "900", letterSpacing: .5, textTransform: "uppercase" },
  profileJournalMood: { color: colors.accent, fontSize: 9, fontWeight: "900" },
  profileJournalEntryTitle: { marginTop: 7, color: colors.text, fontFamily: "serif", fontSize: 17, fontWeight: "900" },
  profileJournalMedia: { marginTop: 2, color: colors.muted, fontSize: 11, fontWeight: "800" },
  profileJournalTags: { marginTop: 7, flexDirection: "row", flexWrap: "wrap", gap: 4 },
  profileJournalTag: { paddingHorizontal: 7, paddingVertical: 3, borderRadius: 99, overflow: "hidden", color: colors.accent, backgroundColor: "rgba(240,90,56,.11)", fontSize: 8, fontWeight: "900" },
  profileJournalWatch: { alignSelf: "flex-start", marginTop: 7, flexDirection: "row", alignItems: "center", gap: 4 },
  profileJournalWatchText: { maxWidth: 210, color: colors.muted, fontSize: 9, fontWeight: "800" },
  profileJournalExcerpt: { marginTop: 7, color: colors.muted, fontFamily: "serif", fontSize: 12, lineHeight: 18 },
  ...
  notificationDecisionCard: { flexDirection: "column", alignItems: "stretch", padding: 13 },
  notificationDecisionMain: { flexDirection: "row", alignItems: "center", gap: 12 },
  notificationDecisionActions: { marginTop: 13, flexDirection: "row", gap: 8 },
  notificationDecisionPrimary: { flex: 1, minHeight: 42, borderRadius: 12, backgroundColor: colors.accent, alignItems: "center", justifyContent: "center", paddingHorizontal: 12 },
  notificationDecisionPrimaryText: { color: colors.text, fontSize: 12, fontWeight: "900" },
  notificationDecisionSecondary: { flex: 1, minHeight: 42, borderWidth: 1, borderColor: colors.line, borderRadius: 12, backgroundColor: colors.panel2, alignItems: "center", justifyContent: "center", paddingHorizontal: 12 },
  notificationDecisionSecondaryText: { color: colors.text, fontSize: 12, fontWeight: "900" },
  notificationDecisionDisabled: { opacity: 0.55 },
  notificationDecisionLink: { minHeight: 34, marginTop: 5, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 3 },
  notificationDecisionLinkText: { color: colors.muted, fontSize: 11, fontWeight: "800" },
  ...
  historyFocusDate: { marginHorizontal: 18, marginBottom: 14, padding: 12, borderWidth: 1, borderColor: "rgba(240,90,56,.25)", borderRadius: 13, backgroundColor: "rgba(240,90,56,.06)", flexDirection: "row", alignItems: "center", gap: 10 },
  historyFocusDateCopy: { flex: 1, minWidth: 0 },
  historyFocusDateLabel: { color: colors.accent, fontSize: 8, fontWeight: "900", letterSpacing: 1.1 },
  historyFocusDateValue: { marginTop: 3, color: colors.text, fontSize: 12, fontWeight: "900" },
  historyFocusDateClear: { minHeight: 34, paddingHorizontal: 8, flexDirection: "row", alignItems: "center", gap: 4 },
  historyFocusDateClearText: { color: colors.muted, fontSize: 9, fontWeight: "900" },
  ...
  watchLogSheetKeyboard: { bottom: 0, maxHeight: "100%", paddingTop: 10, paddingBottom: 10 },
  ...
  watchCustomBoxKeyboard: { marginTop: 2, borderTopWidth: 0, paddingTop: 2 },
  ...
  watchInputError: { color: colors.danger, fontSize: 11, lineHeight: 16, fontWeight: "800", marginTop: 7 },
