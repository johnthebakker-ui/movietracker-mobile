...
export const styles = StyleSheet.create({
  ...
  profileJournalIntro: { marginTop: 14, padding: 15, borderWidth: 1, borderColor: colors.line, borderRadius: 16, backgroundColor: colors.panel, flexDirection: "row", alignItems: "center", gap: 12 },
  ...
  profileJournalSearch: { marginTop: 12, minHeight: 48, paddingHorizontal: 14, borderWidth: 1, borderColor: colors.line, borderRadius: 14, backgroundColor: colors.panel, flexDirection: "row", alignItems: "center", gap: 9 },
  profileJournalSearchInput: { flex: 1, minWidth: 0, color: colors.text, fontSize: 13 },
  profileJournalEntry: { marginTop: 12, padding: 12, borderWidth: 1, borderColor: colors.line, borderRadius: 17, backgroundColor: colors.panel, flexDirection: "row", alignItems: "center", gap: 12 },
